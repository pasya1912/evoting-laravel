...
@section('konten')
            <div class="row">
                ...
                <div class="col-12 col-md-7 col-lg-4">
                    <div class="card">
                        <div class="card-body ">
                        <form method="post" action="{{ route('admin.setting.save') }}" enctype="application/form-data">
						{{ csrf_field() }}
...
<script>
   ...
   $(function () {
       $('#startdate').datetimepicker({
        defaultDate: new Date({{$startdate}}000),
   useCurrent: false //Important! See issue #1075
   });
       $('#enddate').datetimepicker({
        defaultDate: new Date({{$enddate}}000),
   useCurrent: false //Important! See issue #1075
   });
